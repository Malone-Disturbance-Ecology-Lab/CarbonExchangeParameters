...
message("This function uses the equation:
          ...
          where NEE= net ecosystem exchange in 𝜇mol m-2 s-1
                ...
                a1 is the initial quantum efficiency or intrinsic quantum yield , a parameter
                PAR = Photosynthetically active radiation in mol m-2 s-1
                r is dark respiration rate, a parameter
...
LRC_PARMS_03 <- function( data.frame, iterations, priors.lrc, idx.colname, NEE.colname , PAR.colname ){
