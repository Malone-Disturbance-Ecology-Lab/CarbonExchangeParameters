...
|LRC_PARMS_06	  | $$NEE = P_m \left( 1 - \exp \left( \alpha \cdot \left( \text{PAR} - I_{\text{comp}} \right) \right) \right) $$ | NEE; PAR|
|LRC_PARMS_07	  | $$NEE = \frac{a_1 \cdot \text{PAR} \cdot \beta}{a_1 \cdot \text{PAR} + \beta} $$| NEE; PAR; VPD|
|TRC_PARMS_01   | $$R_{\text{eco}} = R_{\text{ref}} \exp\left( E_0 \left( \frac{1}{T_{\text{ref}} - T_0} - \frac{1}{T - T_0} \right) \right)$$| NEE; T|
...
|TRC_PARMS_07   | $$\text{Reco} = a \cdot \exp \left( b \cdot T \right) $$|NEE; T|
