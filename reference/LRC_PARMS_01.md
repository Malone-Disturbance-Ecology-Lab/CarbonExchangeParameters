...
\text{PAR} \cdot a_x}{a_1 \cdot \text{PAR} + a_x} - r\$\$

Where \\r\\ is ecosystem respiration (\\\mu\\mol CO2 m-2 s-1), \\a_1\\
is the apparent quantum efficiency of CO2 uptake (CO2), and \\a_x\\ is
the maximum CO2 uptake rate on the ecosystem scale.
