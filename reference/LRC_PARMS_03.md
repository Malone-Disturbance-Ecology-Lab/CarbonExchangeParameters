...
\left( -\frac{a_1 \cdot \text{PAR}}{a_x} \right) \right) - r\$\$

Where NEE is net ecosystem exchange in \\\mu\\mol m-2 s-1, \\a_x\\ is
light-saturated net photosynthetic rate, \\a_1\\ is the initial quantum
efficiency or intrinsic quantum yield, PAR is Photosynthetically active
radiation in \\\mu\\mol m-2 s-1, and \\r\\ is dark respiration rate.
...
LRC_PARMS_03(
  ...
  priors.lrc = brms::prior("normal(-9.9, 0.4)", nlpar = "ax", lb = -15, ub = 1) +
    ...
    brms::prior("normal(1.2, 0.11)", nlpar = "r", lb = 1, ub = 3.2),
  idx.colname = NULL,
  NEE.colname = NULL,
  PAR.colname = NULL
)
